    ...
    uint64_t exiting)
{
    ...
    if (status->is_infinite) {
        fprintf(stderr,
                "rate:%6.2f-kpps, syn/s=%.0f ack/s=%.0f tcb-rate=%.0f, %" PRIu64 "-tcbs,         \n",
                        x/1000.0,
                        syn_rate,
                        synack_rate,
                        tcb_rate,
        ...
        if (is_tx_done) {
            ...
            fprintf(stderr,
                        "rate:%6.2f-kpps, %5.2f%% done, waiting %d-secs, found=%" PRIu64 "       \n",
                        x/1000.0,
                        percent_done,
                        (int)exiting,
                        total_synacks
            ...
            fprintf(stderr,
                "rate:%6.2f-kpps, %5.2f%% done,%4u:%02u:%02u remaining, found=%" PRIu64 "       \n",
                        x/1000.0,
                        percent_done,
